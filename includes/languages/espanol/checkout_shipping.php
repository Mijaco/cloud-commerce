...
define('ERROR_NO_SHIPPING_AVAILABLE_TO_SHIPPING_ADDRESS', 'Actualmente Envío no está disponible para la dirección de envío seleccionado. Por favor seleccione o crear una nueva dirección de envío para utilizar con su compra.'); 
?>
